...
export const MOCK_DELIVERABLES: DeliverableCell[] = [
  ...
  { id: 'CMN-REVW', workstreamCode: 'CMN', workstreamName: '공통', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'PRC-REVW', workstreamCode: 'PRC', workstreamName: '프로세스', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'MEQ-REVW', workstreamCode: 'MEQ', workstreamName: '주기기', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'ELE-REVW', workstreamCode: 'ELE', workstreamName: '전기', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'INS-REVW', workstreamCode: 'INS', workstreamName: '계장', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'MEC-REVW', workstreamCode: 'MEC', workstreamName: '기계', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'WTR-REVW', workstreamCode: 'WTR', workstreamName: '수처리', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'CIV-REVW', workstreamCode: 'CIV', workstreamName: '토목', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'ARC-REVW', workstreamCode: 'ARC', workstreamName: '건축', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'PIP-REVW', workstreamCode: 'PIP', workstreamName: '배관', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'LAY-VEND', workstreamCode: 'LAY', workstreamName: '공간', stageCode: 'VEND', stageName: 'Vendor 선정', status: 'blocked', origin: null, statusText: '', actions: [] },
  { id: 'LAY-REVW', workstreamCode: 'LAY', workstreamName: '공간', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
  ...
  { id: 'UTL-VEND', workstreamCode: 'UTL', workstreamName: '설비', stageCode: 'VEND', stageName: 'Vendor 선정', status: 'blocked', origin: null, statusText: '', actions: [] },
  { id: 'UTL-REVW', workstreamCode: 'UTL', workstreamName: '설비', stageCode: 'REVW', stageName: '대조·평가', status: 'blocked', origin: null, statusText: '', actions: [] },
]
