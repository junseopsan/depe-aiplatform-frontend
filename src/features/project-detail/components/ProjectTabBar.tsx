...
const TABS: Tab[] = [
  ...
  { id: 'design-criteria', label: 'Design Criteria', segment: 'design-criteria' },
...
export const ProjectTabBar = ({ projectId }: ProjectTabBarProps) => {
  ...
  return (
    <nav className="flex h-10 shrink-0 items-center border-b border-[var(--gray-200)] bg-card px-8">
      {TABS.map((tab, i) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={cn(
              'inline-flex h-10 items-center border-b-2 px-4 text-[13px] transition-colors',
              i === 0 && '-ml-4',
              isActive
